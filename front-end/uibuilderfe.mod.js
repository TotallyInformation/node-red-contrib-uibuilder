 ...
 * @returns {*} Public functions and variables
 */
function uib() { // eslint-disable-line sonarjs/cognitive-complexity
    ...
    /** HTTP Ping/Keep-alive - makes a call back to uibuilder's ExpressJS server and receives a 201 response
...
} // --- End of uibuilder function --- //

const uibuilder = window.uibuilder = uib()
