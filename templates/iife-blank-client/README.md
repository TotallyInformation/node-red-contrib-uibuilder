...
This template uses the IIFE version of the modern client library. This is the standard non-ESM method and simply needs the client to be referenced in an HTML `link` element.
It is an extended version of the default "blank" template.
