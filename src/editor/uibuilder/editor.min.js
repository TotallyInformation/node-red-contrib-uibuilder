!function(){"use strict";const t="127.0.0.1"===location.hostname,i=t?console.log:function(){};if(i("[uibuilder] DEBUG ON (because running on localhost)"),Object.entries||(Object.entries=function(e){for(var t=Object.keys(e),i=t.length,o=new Array(i);i--;)o[i]=[t[i],e[t[i]]];return o}),!Object.values){const R=Function.bind.call(Function.call,Array.prototype.reduce),D=Reflect.ownKeys,C=Function.bind.call(Function.call,Array.prototype.concat),L=Function.bind.call(Function.call,Object.prototype.propertyIsEnumerable);Object.values=function(i){return R(D(i),(e,t)=>C(e,"string"==typeof t&&L(i,t)?[i[t]]:[]),[])}}const e=432e3,s="Replace This With A Real Secret",n="blank",o={};var a=[],r=RED.settings.uibuilderInstances;const u={format:"html",folder:"src",fname:"index.html",fullscreen:!1};function p(o){if(""===o||"string"!=typeof o)return"No package";RED.notify("Starting removal of npm package "+o),$("i.spinner").show(),$.get("uibuilder/uibnpmmanage?cmd=remove&package="+o,function(e){!0===e.success?(console.log("[uibuilder:removePackageRow:get] PACKAGE REMOVED. ",o),RED.notify("Successfully uninstalled npm package "+o,"success"),a[o]&&delete a[o]):(console.log("[uibuilder:removePackageRow:get] ERROR ON PACKAGE REMOVAL ",e.result),RED.notify("FAILED to uninstall npm package "+o,"error"),$("#node-input-packageList").editableList("addItem",o)),$("i.spinner").hide()}).fail(function(e,t,i){return console.error("[uibuilder:removePackageRow:get] Error "+t,i),RED.notify("FAILED to uninstall npm package "+o,"error"),$("#node-input-packageList").editableList("addItem",o),$("i.spinner").hide(),"removePackageRow failed"})}function f(e){let t="text",i=e.split(".");if(""===i[0]&&i.shift(),1<i.length){var o=i.pop().toLowerCase().trim();switch(o){case"js":t="javascript";break;case"html":case"css":case"json":t=o;break;case"vue":t="html";break;case"md":t="markdown";break;case"yaml":case"yml":t="yaml";break;default:t=o}}return t}function l(e){$("#edit-save").prop("disabled",e),$("#edit-reset").prop("disabled",e),$("#edit-close").prop("disabled",!e),$("#node-edit-file").prop("disabled",!e),$("#node-input-filename").prop("disabled",!e),$("#node-dialog-ok").prop("disabled",!e),$("#node-dialog-cancel").prop("disabled",!e),e?($("#node-dialog-ok").css("cursor","pointer"),$("#node-dialog-cancel").css("cursor","pointer")):($("#file-action-message").text("Save Required"),$("#node-dialog-ok").css("cursor","not-allowed"),$("#node-dialog-cancel").css("cursor","not-allowed"))}function c(){var e=$("#node-input-url").val(),t=$("#node-input-folder").val(),i=(null===t&&(t=localStorage.getItem("uibuilder."+e+".folder")||u.folder),$("#node-input-filename").val()),o=(null===i&&(i=localStorage.getItem("uibuilder."+e+".selectedFile")||u.fname),u.folder=t,u.fname=i,localStorage.setItem("uibuilder."+e+".folder",u.folder),localStorage.setItem("uibuilder."+e+".selectedFile",u.fname),u.format=f(i));$("#node-input-format").val(o),$.get("uibuilder/uibgetfile?url="+e+"&fname="+i+"&folder="+t,function(e){$("#node-input-template-editor").show(),$("#node-input-template-editor-no-file").hide(),u.editorSession.setValue(e),u.editorSession.setMode({path:"ace/mode/"+o,v:Date.now()}),u.editorSession.getUndoManager().isClean(),u.editor.focus()}).fail(function(e,t,i){console.error("[uibuilder:getFileContents:get] Error "+t,i),u.editorSession.setValue(""),$("#node-input-template-editor").hide(),$("#node-input-template-editor-no-file").show()}).always(function(){l(!0),$("#node-input-format option:selected").length||$("#node-input-format").val("text")})}function d(d){var a=$("#node-input-url").val(),s=$("#node-input-folder").val(),e=$("#node-input-filename").val();null===(d=void 0===d?e:d)&&(d=localStorage.getItem("uibuilder."+a+".selectedFile")||void 0),null===s&&(s=localStorage.getItem("uibuilder."+a+".folder")||void 0),$("#node-input-filename option").remove(),$("#node-input-folder option").remove(),$.ajax({type:"GET",dataType:"json",url:"./uibuilder/admin/"+a,data:{cmd:"listall"}}).done(function(e,t,i){let o="",n=!1,r=!1;var l=Object.keys(e).sort(),l=($.each(l,function(e,t){""===t&&(t="root"),$("#node-input-folder").append($("<option>",{value:t,text:t}))}),e[s]||(s=e.src?"src":"root"),$("#node-input-folder").val(s),u.folder=s,localStorage.setItem("uibuilder."+a+".folder",s),e[s]);$.each(l,function(e,t){$("#node-input-filename").append($("<option>",{value:t,text:t})),0===e&&(o=t),t===u.fname&&(n=!0),t===d&&(r=!0)}),!0===r?u.fname=d:!0===n?u.fname="index.html":u.fname=o,$("#node-input-filename").val(u.fname),u.format=f(u.fname),localStorage.setItem("uibuilder."+a+".selectedFile",u.fname)}).fail(function(e,t,i){console.error("[uibuilder:getFileList:getJSON] Error "+t,i),u.fname="",u.format="text",RED.notify("uibuilder: Folder and file listing error.<br>"+i,{type:"error"})}).always(function(){c()})}function b(){let e;if(!0===u.editorLoaded){if(document.fullscreenElement)$("#edit-props").css("background-color","#f6f6f6").css("padding","1em"),e=parseInt($("#edit-props").css("height"),10),e-=25,$("#node-function-expand-js").css("background-color","black").html('<i class="fa fa-compress"></i>'),u.fullscreen=!0;else{if("auto"===$("#edit-outer").css("top"))return;$("#edit-props").css("background-color","").css("padding",""),e=$(".red-ui-tray-footer").position().top-$("#edit-outer").offset().top-35,$("#node-function-expand-js").css("background-color","").html('<i class="fa fa-expand"></i>'),u.fullscreen=!1}for(var t=$("#edit-props > div:not(.node-text-editor-row)"),i=0;i<t.length;i++)e-=$(t[i]).outerHeight(!0);$("#node-input-template-editor").css("height",e+"px"),u.editor.resize()}}function h(e){$.ajax({type:"GET",async:!1,dataType:"json",url:"./uibuilder/admin/_",data:{cmd:"listinstances"},success:function(e){r=e}}),e&&(e.isDeployed=void 0!==r[e.id])}function g(e,t=!0){!0===t?($("#node-input-templateFolder, #btn-load-template").prop("disabled",!1).css({cursor:"pointer"}),$("#red-ui-tab-tab-files, #red-ui-tab-tab-libraries, #red-ui-tab-tab-security, #red-ui-tab-tab-advanced, info").css({cursor:"pointer"}),$("#red-ui-tab-tab-files>a, #red-ui-tab-tab-libraries>a, #red-ui-tab-tab-security>a, #red-ui-tab-tab-advanced>a, info>a").prop("disabled",!1).css({"pointer-events":"auto",cursor:"pointer",opacity:1}),$("#uibuilderurl, #uibinstanceconf").prop("disabled",!1).css({cursor:"pointer",opacity:1}),$("#url-errors").remove()):($("#node-input-templateFolder, #btn-load-template").prop("disabled",!0).css({cursor:"not-allowed"}),$("#red-ui-tab-tab-files, #red-ui-tab-tab-libraries, #red-ui-tab-tab-security, #red-ui-tab-tab-advanced, info").css({cursor:"not-allowed"}),$("#red-ui-tab-tab-files>a, #red-ui-tab-tab-libraries>a, #red-ui-tab-tab-security>a, #red-ui-tab-tab-advanced>a, info>a").prop("disabled",!0).css({"pointer-events":"none",cursor:"not-allowed",opacity:.3}),$("#uibuilderurl, #uibinstanceconf").prop("disabled",!0).css({cursor:"not-allowed",opacity:.3}),$("#url-errors").remove(),$("#url-input").after(`
                <div id="url-errors" class="form-row" style="color:var(--red-ui-text-color-error)">
                    ${Object.values(e).join("<br>")} 
                </div>
            `))}function m(){var e,t=$("#node-input-templateFolder").val();if(RED.settings.uibuilderTemplates[t]){const i=RED.settings.uibuilderTemplates[t].dependencies||[],o=[];i.forEach(e=>{a[e]||o.push(e)}),0<o.length&&(e=RED.notify(`WARNING<br /><br />The selected uibuilder template (${t}) is MISSING the following dependencies:<div> ${o.join(", ")}</div><br />Please install them using the uibuilder Library Manager or select a different template.`,{type:"warning",modal:!0,fixed:!0,buttons:[{text:"OK",class:"primary",click:function(){e.close()}}]}))}else console.error("[uibuilder:checkDependencies] Template name not found: "+t)}function v(){var o=RED.notify(`WARNING<br /><br />
            Are you <b>SURE</b> you want to overwrite your code
            with the template <b><code>${$("#node-input-templateFolder").val()}</code></b>?<br /><br />
            <b>THIS CANNOT BE UNDONE.</b>`,{type:"warning",modal:!0,fixed:!0,buttons:[{text:"Cancel, don't overwrite",class:"primary",click:function(){o.close()}},{text:"OK, overwrite",click:function(){var e,t,i;e=$("#node-input-templateFolder").val(),t=$("#node-input-extTemplate").val(),i=$("#node-input-url").val(),$.ajax({type:"POST",dataType:"json",url:"./uibuilder/admin/"+i,data:{template:e,extTemplate:t,cmd:"replaceTemplate"}}).done(function(e,t,i){return RED.notify(`<b>uibuilder</b>:<br><br>${i.statusText}<br>`,{type:"success"}),"Template load succeeded"}).fail(function(e,t,i){return console.error("[uibuilder:loadTemplate] Error "+t,i),RED.notify(`<b>uibuilder</b>:<br><br>Template Load Error.<br><br>${i}<br>`,{type:"error"}),"Template load failed"}),o.close()}}]})}function y(i){$("#adv-templ").hide(),$("#show-templ-props").css("cursor","pointer"),$("#show-templ-props").on("click",function(){$("#adv-templ").toggle(),$("#adv-templ").is(":visible")?$("#show-templ-props").html('<i class="fa fa-caret-down"></i> Template Settings'):$("#show-templ-props").html('<i class="fa fa-caret-right"></i> Template Settings')});{var o=i;let e=o.templateFolder,t=[];RED.settings&&RED.settings.uibuilderTemplates?t=RED.settings.uibuilderTemplates:console.error("[uibuilder:populateTemplateDropdown] Cannot access RED.settings for node "+o.id),Object.values(t).forEach(e=>{$("#node-input-templateFolder").append($("<option>",{value:e.folder,text:e.name}))}),t[e]||(e=n),$(`#node-input-templateFolder option[value="${e}"]`).prop("selected",!0),$("#node-input-templateFolder").val(e),$("#node-templSel-info").text(t[e].description),e}m(),"external"===$("#node-input-templateFolder").val()&&$("#et-input").show(),$("#node-input-templateFolder").on("change",function(){RED.settings.uibuilderTemplates[i.templateFolder]&&$("#node-templSel-info").text(RED.settings.uibuilderTemplates[i.templateFolder].description),m(),"external"===$("#node-input-templateFolder").val()?$("#et-input").show():$("#et-input").hide()}),$("#btn-load-template").on("click",function(e){e.preventDefault(),v()})}function w(){return $(".red-ui-tray-footer").position().top-$("#package-list-container").offset().top+25}function E(d){$("#node-input-packageList").editableList({addItem:function(i,o,n){{var r=d,l=o;o=n;let e="",t;return e=0===Object.entries(o).length?`
                <div>
